  ...
  <div class="container">
    <div class="flex justify-between items-center">
      ...
      <div class="lg:hidden" x-data="{open: false}">
        ...
        <div class="mobile-menu fixed bg-white w-full h-full top-0 right-0 max-w-3xl z-50" role="navigation" x-show="open" x-on:click.away="open = false" x-bind:aria-expanded="open" x-bind:aria-label="open ? 'Close Menu' : 'Open Menu'" x-bind:class="open ? 'open' : ''">
          <?php if( has_nav_menu( 'primary' ) ) : ?>
            <nav role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'pixelone' ); ?>" class="py-12 px-10">
              <?php
                wp_nav_menu( array(
                  'theme_location'    => 'primary',
                  'container'         => false,
